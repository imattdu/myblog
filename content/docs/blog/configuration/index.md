...
| `social` | Object | - | [社交链接]({{< ref "/docs/blog/widgets/social-links" >}})。
| `author` | Object | - | [作者小部件]({{< ref "/docs/blog/widgets/author" >}})。
...
| `reward` | Object | - | [打赏小部件]({{< ref "/docs/blog/widgets/reward" >}})，又称 Buy Me a Coffee 小部件。
| `share` | Object | - | 分享按钮
...
| **Archive**
| `archive` | Object | - | [归档]({{< ref "/docs/blog/layouts/archives" >}})。
| `search` | Object | - | [搜索]({{< ref "/docs/blog/layouts/search" >}})。
...
| `utterances` | Object | - | [Utterances]({{< ref "/docs/blog/widgets/comments#utterances" >}}) 配置。
...
| `viewer` | Boolean | true | [图片查看器]({{< ref "docs/blog/image-viewer" >}})
| `pwa` | Object | - | [渐进式 web 应用]({{< ref "/docs/blog/pwa" >}})
| **Meta Tag**
| `metaRobots` | String | - | 空字符串表示禁用。
| `contact` | Object | - | [联系表单]({{< ref "docs/blog/layouts/contact-form" >}})
